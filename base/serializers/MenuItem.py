...
class MenuItemSerializers(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.category_ref = validated_data.get('category_ref', instance.category_ref)
        ...
        for price_data in prices_data:
            ...
            if price_id:
                ...
                price_instance.size_description = price_data.get('size_description', price_instance.size_description)
                price_instance.save()
